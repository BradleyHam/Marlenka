...
function testimonials() {
  ...
  return (
    ...
    <div className=' flex flex-col xl:flex-row justify-between space-y-10 xl:space-y-0 xl:space-x-4  items-center pt-12'>
      <Testimonial face={'/Images/womanOne.jpg'} customerName='Paul M. Caputo' customerJob='Receptionist at Millbrook' testimonial={`Great cakes, delicious and all natural! I buy them as gifts for clients and they absolutely love them.`}/>
      <Testimonial face={'/Images/manOne.jpg'} customerName='Rebeca Lukacs' customerJob='Joiner' testimonial={`These are very good and addicting. The balls are mushy on the outside and then some wonderful goodness on the inside. Very good flavours.`}/>

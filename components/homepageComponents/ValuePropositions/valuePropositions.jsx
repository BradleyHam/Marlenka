...
function ValuePropositions() {
  return (
    <div className='px-4 sm:px-8 md:px-16 lg:px-32 flex flex-col space-y-12 xl:flex-row xl:space-y-0 xl:space-x-6 justify-between md:items-start py-32 border-b-2'>
